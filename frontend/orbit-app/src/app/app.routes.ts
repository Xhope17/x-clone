...
export const routes: Routes = [
  ...
  // ZONA PÚBLICA (Por defecto)
  {
    path: '',
    loadComponent: () =>
      import('./core/layouts/public/public-layout/public-layout').then(
        (m) => m.PublicLayout
      ),
    children: [
      {
        path: 'home',
        loadComponent: () =>
          import('./features/pages/public/home-page/home-page').then(
            (m) => m.HomePage
          ),
      },
      {
  ...
  // ZONA PRIVADA (Para más adelante)
  {
    ...
    loadComponent: () =>
      import('./core/layouts/private/private-layout/private-layout').then(
        (m) => m.PrivateLayout
      ),
    children: [
